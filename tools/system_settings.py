...
def set_credential(params):
    ...
    Required:
    - tool_name: name of tool (e.g., "doc_editor")
    - value: credential value

    Example:
    {"tool_name": "doc_editor", "value": "sk-outline-abc123"}
    ...
    for entry in registry:
        if entry.get("action") == "__tool__":
            ...
            tools[tool_name] = {
                ...
                "unlocked": entry.get("unlocked", not entry.get("locked", False)),
                "referral_unlock_cost": entry.get("referral_unlock_cost", 0),
