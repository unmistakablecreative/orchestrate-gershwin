...
## file_ops_tool
File operations for extracting content from various formats.
...
find_file(filename_fragment)
  - Find file by name fragment
  - Params: filename_fragment (required)

read_file(filename_fragment)
...
check_safe(command)
  ...
  - Example: {"tool_name": "terminal", "action": "check_safe", "params": {"command": "ls -la"}}

ls(path)
  - List directory contents
  - Params: path (required)
  - Example: {"tool_name": "terminal", "action": "ls", "params": {"path": "/Users/srinivas"}}
...
script(path)
  - Run a script file
  - Params: path (required)
  - Example: {"tool_name": "terminal", "action": "script", "params": {"path": "./deploy.sh"}}

stream(command)
  - Stream command output
  - Params: command (required)
  - Example: {"tool_name": "terminal", "action": "stream", "params": {"command": "ping google.com"}}

tail(command, n)
  - Tail output with line limit
  - Params: command (required), n (optional)
  - Example: {"tool_name": "terminal", "action": "tail", "params": {"command": "cat log.txt", "n": 10}}
```
